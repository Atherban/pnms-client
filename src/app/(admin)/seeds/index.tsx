        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert("Error", "Failed to delete seed. Please try again.");
            }
          },
        },
      ],
            ...
            <View style={styles.seedCard}>
              ...
              <View style={styles.actionsContainer}>
                ...
                <Pressable
                  onPress={() =>
                    router.push({
                      pathname: "/(admin)/seeds/upload-image",
                      params: { id: item._id },
                    })
                  }
                  style={({ pressed }) => [
    ...
    <View style={styles.container}>
      ...
      <View style={styles.fixedHeader}>
        ...
        <View style={styles.searchContainer}>
          ...
          />
          <TextInput
            placeholder="Search seeds, suppliers, or categories..."
